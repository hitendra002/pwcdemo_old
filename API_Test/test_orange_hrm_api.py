...
def login():
    ...
    try:
        ...
        add_res = session.post("https://opensource-demo.orangehrmlive.com/web/index.php/api/v2/pim/employees", data=emplyoeeData)
        ...
        search_emp_res = session.get(f"https://opensource-demo.orangehrmlive.com/web/index.php/api/v2/pim/employees/{empID}/personal-details")
